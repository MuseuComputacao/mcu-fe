...
const legacyVolunteerForm =
  'https://docs.google.com/forms/d/e/1FAIpQLScm6ZKHAKCPXtfKDJDH2P_aWlCOvWAebqlfhf2xYRLPmK2pPA/viewform?usp=sf_link';

const Volunteer = () => {
  const openLegacyVolunteerForm = () => {
    Linking.openURL(legacyVolunteerForm).catch(() => undefined);
  };
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            ...
            <Text accessibilityRole="header" style={styles.title}>Seja Voluntário</Text>
          </View>
        </View>
        ...
        <View style={styles.notice}>
          ...
          <Pressable
            ...
            onPress={openLegacyVolunteerForm}
            style={styles.formLink}
          >
            <Text style={styles.linkText}>Abrir formulário público de voluntariado</Text>
          </Pressable>
        </View>
      </ScrollView>
    </SafeAreaView>
